...
from box.json_decode_error import handle_json_decode_error
...
def print_error_information(error: Exception, frame_to_green: FrameType):
    ...
    from box.frame import frame_gen
...
def make_v_zero_arg(self: "pdb.Pdb", error: Exception):
    ...
    """
    from box.error import print_variables
    def v_zero_arg(*args):
        assert self.curframe
...
if __name__ == "__main__":
    with handler():
        main()
# run.vim: vert term python box/__init__.py
