...
from box.common import print_dict, Date
from box.truncate import truncate, get_display_length
...
def save_ic_table_error(dictionaries):
    ...
    from box.reltools import write
    dt = datetime.now()
...
def data_source_multiline_long_colored_variables():
    ...
    import textwrap
    from box.error import color_D_if_big
    range_count = 100
